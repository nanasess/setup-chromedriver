...
function getDownloadUrl(versionInput, chromeapp) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // execute Chrome binary directly; Windows needs verbatim args, other platforms handle spaces natively
        const execOptions = plat === 'win32' ? { windowsVerbatimArguments: true } : {};
        const result = yield exec.getExecOutput(chromeCmd, ['--version'], execOptions);
