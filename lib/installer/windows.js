...
import { buildLegacyDownloadUrl, getDefaultChromePath, getInstallPath, isLegacyVersion, parseMajorVersion, } from "../chromedriver-helper.js";
...
export async function installOnWindows(opts) {
    ...
    const binary = path.join(extractedDir, "chromedriver-win64", "chromedriver.exe");
