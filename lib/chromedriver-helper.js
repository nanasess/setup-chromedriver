...
export function parseVersion3(version) {
...
// API selection
// ---------------------------------------------------------------------------
export function isLegacyVersion(majorVersion) {
    return majorVersion < 115;
}
// ---------------------------------------------------------------------------
// Platform mapping
// ---------------------------------------------------------------------------
export function mapArchitecture(platform, arch) {
    switch (platform) {
        case "win32":
            return "win32";
        case "darwin":
...
export function convertArchForLegacyAPI(arch) {
...
export function convertArchForModernAPI(arch) {
...
// ---------------------------------------------------------------------------
export function buildLegacyLatestReleaseUrl(majorVersion) {
    return `https://chromedriver.storage.googleapis.com/LATEST_RELEASE_${majorVersion}`;
}
export function buildLegacyDownloadUrl(version, arch) {
    return `https://chromedriver.storage.googleapis.com/${version}/chromedriver_${arch}.zip`;
}
export function extractDriverUrlFromJson(json, version, platform) {
...
export function findFallbackVersion(json, version3) {
...
// Default paths
// ---------------------------------------------------------------------------
export function getDefaultChromePath(platform) {
    switch (platform) {
        case "win32":
...
export function getInstallPath(platform) {
    switch (platform) {
        case "win32":
